...
#Usage:   python get_mask.py output_size_x output_size_y
#
#         or  python get_mask.py output_size_x output_size_y input_folder(default "./input/") output_folder(default "./output/")
